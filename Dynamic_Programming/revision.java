public class revision{
    ...
    public int minCostClimbingStairs1(int[] cost,int n,int[] dp){
          if(n<=1){
            return dp[n] = cost[n]; 
          }
          ...
          int a = minCostClimbingStairs1(cost, n-1,dp);
          int b = minCostClimbingStairs1(cost, n-2,dp);

          return Math.min(a,b) + (n != cost.length ? cost[n] : 0);
    }

    public int minCostClimbingStairs2(int[] cost,int n,int[] dp){
